...
class GetKeyword(Node):
    def __init__(self):
        #위치
        # self.position_map = {
        #     'pos1':[396.728, -202.481, 223.45, 83.724, -154.416,-164.7],
        #     "pos2":[544.557, -215.708, 214.517,111.264,-154.15,-138.373],
        # }
    ...
    def extract_keyword(self, output_message):
        ...
        object, num,target = result.strip().split("/")
    ...
    def get_keyword(self, request, response):  # 요청과 응답 객체를 받아야 함
        ...
        response.message = f"{' '.join(object_list)} / {' '.join(target_list)} / {' '.join(target_list)}"
